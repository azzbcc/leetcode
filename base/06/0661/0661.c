...
// 0 <= img[i][j] <= 255
//
// Related Topics 数组 矩阵 👍 143 👎 0

int **imageSmoother(int **img, int size, int *colSize, int *returnSize, int **returnColumnSizes) {
    int m = size, n = *colSize, **ans = malloc((*returnSize = m) * sizeof(int *));
