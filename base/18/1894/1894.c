// 一个班级里有 n 个学生，编号为 0 到 n - 1 。每个学生会依次回答问题，编号为 0 的学生先回答，然后是编号为 1的学生，
...
// 1 <= k <= 10⁹
//
// Related Topics 数组 二分查找 前缀和 模拟 👍 30 👎 0

int chalkReplacer(int *chalk, int size, int k) {
    long prefix[size], ans = 0;
